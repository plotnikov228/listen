...
class ListfiftyeightItemWidget extends StatelessWidget {
  ListfiftyeightItemWidget(this.listfiftyeightItemModelObj);

  ListfiftyeightItemModel listfiftyeightItemModelObj;
