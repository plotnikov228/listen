...
class ListseventyoneItemWidget extends StatelessWidget {
  ListseventyoneItemWidget(this.listseventyoneItemModelObj);

  ListseventyoneItemModel listseventyoneItemModelObj;
