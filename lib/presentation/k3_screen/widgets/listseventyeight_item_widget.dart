...
class ListseventyeightItemWidget extends StatelessWidget {
  ListseventyeightItemWidget(this.listseventyeightItemModelObj);

  ListseventyeightItemModel listseventyeightItemModelObj;
